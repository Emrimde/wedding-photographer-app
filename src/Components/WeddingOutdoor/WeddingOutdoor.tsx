...
import { image1 } from "../../images/wedding-outdoor2.jpg";
                        ...
                        <div id="carouselExample" className="carousel slide">
                            <div className="carousel-inner">
                                <div className="carousel-item">
                                    <img src={require("../../images/wedding-outdoor1.jpg")} className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item active">
                                    <img src={require("../../images/wedding-outdoor2.jpg")} className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src={require("../../images/wedding-outdoor3.jpg")} className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src={require("../../images/wedding-outdoor4.jpg")} className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src={require("../../images/wedding-outdoor5.jpg")} className="d-block w-100" alt="..." />
                                </div>
                                {/* <div className="carousel-item">
                                    <img src={require("../../images/wedding-outdoor6.jpg")} className="d-block w-100" alt="..." />
                                </div> */}
                                <div className="carousel-item">
                                    <img src={require("../../images/wedding-outdoor7.jpg")} className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src={require("../../images/wedding-outdoor8.jpg")} className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src={require("../../images/wedding-outdoor9.jpg")} className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src={require("../../images/wedding-outdoor10.jpg")} className="d-block w-100" alt="..." />
                                </div>
