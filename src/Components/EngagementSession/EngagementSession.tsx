                    ...
                    <div className="col-sm-12">
                        <div id="carouselExample" className="carousel slide">
                            ...
                            <div className="carousel-item active">
                                    <img src={require("../../images/engagement-session1.jpg")} className="d-block w-100 " alt="..." />
                                </div>
                                
                                

                                <div className="carousel-item">
                                    <img src={require("../../images/engagement-session3.jpg")} className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src={require("../../images/engagement-session4.jpg")} className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src={require("../../images/engagement-session5.jpg")} className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src={require("../../images/engagement-session6.jpg")} className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src={require("../../images/engagement-session7.jpg")} className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src={require("../../images/engagement-session8.jpg")} className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src={require("../../images/engagement-session9.jpg")} className="d-block w-100" alt="..." />
                                </div>
                            </div>
